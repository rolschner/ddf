...
public class TestKMLTransformerImpl {
    ...
    public void testPerformDefaultTransformationPointLocation() throws CatalogTransformerException {
        ...
        assertThat(placemark.getTimePrimitive(), is(TimeStamp.class));
        TimeStamp timeStamp = (TimeStamp) placemark.getTimePrimitive();
        assertThat(timeStamp.getWhen(), is(dateFormat.format(metacard.getEffectiveDate())));
    ...
    public void testTransformMetacardGetsDefaultStyle() throws CatalogTransformerException,
        ...
        assertThat(content.getMimeTypeValue(), is(KMLTransformerImpl.KML_MIMETYPE));
